...
output "status_incidents_d1_database_id" {
  description = "D1 database ID for status.romashov.tech incident banners (also in services/status/wrangler.toml)."
  value       = module.cloudflare.status_incidents_d1_database_id
}
